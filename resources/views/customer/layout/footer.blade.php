    ...
    <div class="container">
        ...
        <div class="row py-5 my-4">
            <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                <h2 class="font-weight-semibold text-color-light ls-0 mb-0">EXELPACK</h2>
                <h5 class="text-muted">Packaging for Exellence</h5>
                ...
                <!-- <style>
                    ...
                    <div id="map" class="google-map m-0" style="height: 190px;"></div>
                 -->
            </div>
                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <li class="mb-2 ">
                        <a href="#">
                            <p class="text-3 text-color-light opacity-8 mb-0">
                                <i class="fas fa-angle-right text-color-primary"></i>
                                <strong class="ms-2 font-weight-semibold">OUR PRODUCTS</strong>
                            </p>
                        </a>
                    </li>
                    <li class="mb-2 ">
            ...
            <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                <div class="contact-details">
                    ...
                    <ul class="list list-icons list-icons-lg">
                        <li class="mb-1"><i class="far fa-dot-circle text-color-primary"></i><p class="m-0">Blk 2 Lot 2 Filinvest Technology Park, Ciudad de Calamba</p></li>
                        <li class="mb-1"><i class="fab fa-whatsapp text-color-primary"></i><p class="m-0"><a href="tel:8001234567">(049) 502-0295</a></p></li>
                        <li class="mb-1">
                            <i class="far fa-envelope text-color-primary"></i>
                            <p class="m-0">
                                <a href="#">
                                    <span>lvibora@exelpackcorp.com</span>
                                </a>
                            </p>
                        </li>
                    </ul>
